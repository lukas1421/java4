...
public class ComboLeg {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 13 * hash + this.m_conid;
        hash = 13 * hash + this.m_ratio;
        hash = 13 * hash + Objects.hashCode(this.m_action);
        hash = 13 * hash + Objects.hashCode(this.m_exchange);
        hash = 13 * hash + this.m_openClose;
        hash = 13 * hash + this.m_shortSaleSlot;
        hash = 13 * hash + Objects.hashCode(this.m_designatedLocation);
        hash = 13 * hash + this.m_exemptCode;
        return hash;
    }
