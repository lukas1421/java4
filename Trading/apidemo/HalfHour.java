...
public enum HalfHour {
    ...
    H1(ltof(9, 30)), H2(ltof(10, 0)), H3(ltof(10, 30)), H4(ltof(11, 0)), H5(ltof(13, 0)), H6(ltof(13, 30)), H7(ltof(14, 0)), H8(ltof(14, 30));

    private LocalTime startTime;

    private static final Map<LocalTime, HalfHour> lookup = new HashMap<>();
    private static final Map<LocalTime, AutoOrderType> timeOrderMap = new HashMap<>();
