...
class Graph extends JComponent implements GraphFillable {
    ...
    Graph(NavigableMap<LocalTime, Double> tm) {
    ...
    void setNavigableMap(NavigableMap<LocalTime, ?> tm) {
